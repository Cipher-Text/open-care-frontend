  ...
  useEffect(() => {
    const fetchContributors = async () => {
      try {
        ...
        // Role mapping based on contributor login - can be customized as needed
        const roleMap: Record<string, string> = {
          imran110219: "Lead Developer",
        ...
        // Type for contributor from API response
        ...
        // Fetch all contributors from the backend API
        const response = await apiClient.get(`/api/public/github/contributors`);

        // Process contributors
        const developersList: Developer[] = response.data
          .filter(
          ...
          .sort(
            (a: Developer, b: Developer) => b.contributions - a.contributions
          );
