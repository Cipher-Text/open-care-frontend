...
export function DataTable<TData, TValue>({
  ...
  }, [searchValue, selectedSort, selectedDirection, onFilterChange]);

  const handleClearFilters = () => {
    setSearchValue("");
    setSelectedSort("id");
    setSelectedDirection("DESC");
    onFilterChange?.({ search: "", sort: "id", direction: "DESC" });
  };

  const hasActiveFilters =
    searchValue !== "" || selectedSort !== "id" || selectedDirection !== "DESC";
        ...
        <div className="flex items-center space-x-2 flex-1">
          ...
          <Select value={selectedSort} onValueChange={setSelectedSort}>
            ...
            <SelectContent>
              ...
              <SelectItem value="foundedDate">Founded Date</SelectItem>
            </SelectContent>
          </Select>
      ...
      {totalItems !== undefined && totalPages !== undefined && onPageChange && (
        <div className="flex items-center justify-end space-x-2 py-4">
          <div className="flex-1 text-sm text-muted-foreground">
            {totalItems} total association{totalItems === 1 ? "" : "s"}
          </div>
          <DataTablePagination
            table={table}
